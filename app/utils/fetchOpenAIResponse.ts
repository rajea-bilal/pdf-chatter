/**
 * This function handles the communication with NVIDIA's AI API.
 * It:
 * - Takes messages from the chat (chat history), 
 * function that updates the chat history with AI response, 
 * function to handle errors
 * - Sends them to the AI
 * - Gets back the AI's response in chunks (streaming)
 * - Updates the chat as responses come in
